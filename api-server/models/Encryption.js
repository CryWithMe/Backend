// Code Author - Grant Ayers
// Class that encapsulates all the encryption which falls into two categories, salting and hashing
// EncryptObject takes in two variables, password and salt, if the account is being created just pass in empty quotes
// And the salt will automatically be generated, note this requires salt to be stored and retrieved for password check.
